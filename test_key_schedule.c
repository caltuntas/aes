...
static void test_shift_rows(void)
{
    ...
    uint8_t expected[16]={0xd4,0xbf,0x5d,0x30,0xe0,0xb4,0x52,0xae,0xb8,0x41,0x11,0xf1,0x1e,0x27,0x98,0xe5};
    uint8_t res[16] = {0};
    shift_rows(state,res);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected,res,16);
}

static void test_mix_columns(void)
{
    uint8_t state[16]={0xd4,0xbf,0x5d,0x30,0xe0,0xb4,0x52,0xae,0xb8,0x41,0x11,0xf1,0x1e,0x27,0x98,0xe5};
    uint8_t expected[16]={0x04,0x66,0x81,0xe5,0xe0,0xcb,0x19,0x9a,0x48,0xf8,0xd3,0x7a,0x28,0x06,0x26,0x4c};
    uint8_t res[16] = {0};
