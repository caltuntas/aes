...
static void test_expand_key2(void)
{
...
static void test_aes_enc(void)
{
  ...
  aes_enc(text, key);
  TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, text, 16);
  TEST_ASSERT_EQUAL_HEX8_ARRAY(expected_key, key, 16);
}
...
static void test_cbc_mode(void) 
{
  ...
  aes_cbc_enc(plain_text, key, iv);
  TEST_ASSERT_EQUAL_HEX8_ARRAY(expected, plain_text, 48);
}
